import { Blockquote, Group, Stack, Text, ThemeIcon, Title } from '@mantine/core';
...
import { IconBlockquote, IconQuestionMark } from '@tabler/icons-react';
...
export default function({ anticheats, breakdown, ...stats }: InferGetStaticPropsType<typeof getStaticProps>) {
    ...
    return (
        <Stack align="center" mt={70} mb={50}>
            <Blockquote cite="- Starz0r" mb={50} color="gray" icon={<IconBlockquote />}>
                <Text fz="18px">
            ...
            <Group mt={30} wrap="nowrap">
                ...
                <ImageSelect
                    searchable
                    onChangeCb={setAnticheat}
                    value={selectedAnticheat}
                    nothingFoundMessage="No such AntiCheat"
